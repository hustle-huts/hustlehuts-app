    ...
    <footer className={styles.navbar}>
      <div className={styles.iconContainer}>
        <a href="#" onClick={() => handleNavItemClick("home")}>
          {props.currentPage !== "home" && <Image alt="homepage navbar icon" src={home} width="600" height="300" />}
      ...
      <div className={styles.iconContainer}>
        <a href="#" onClick={() => handleNavItemClick("book")}>
          {props.currentPage !== "book" && <Image alt="booking page navbar icon" src={book} width="600" height="300" />}
