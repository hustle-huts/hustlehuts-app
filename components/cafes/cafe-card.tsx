...
const CafeCard: React.FC<props> = (props) => {
  return (
    <Card className={styles.cafeCard}>
      <CardMedia className={styles.cafeImage} image="./images/booking-image.png" title="Cafe Image">
        <Button className={styles.cafeOpenButton} onClick={() => console.log("Open Cafe")} variant="text">
          OPEN
        </Button>
        <div className={styles.cafeCredit}>1 Credit /hr</div>
        <Button className={styles.cafeLike} onClick={() => console.log("Like Cafe")} variant="text">
